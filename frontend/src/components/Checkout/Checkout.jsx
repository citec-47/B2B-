...
const Checkout = () => {
  ...
  const totalPrice = Math.max(
    subTotalPrice + shipping - discountAmount,
    0
  ).toFixed(2);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // check if coupon applies to cart shop
      ...
      const discountAmount = (eligiblePrice * coupon.value) / 100;
    ...
    <div className="w-full bg-[#fff] rounded-md p-5 pb-8">
      ...
      <div className="flex justify-between border-b pb-3">
        ...
        <h5 className="text-[18px] font-[600]">
          - {discountAmount ? `$${discountAmount.toFixed(2)}` : null}
        </h5>
      </div>
